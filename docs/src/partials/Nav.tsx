...
const Nav = () => {
  return (
    <div className="sticky top-0 z-20 flex w-full -translate-y-24 animate-translate-down items-stretch justify-center border-b border-b-slate-200/50 bg-white/20 text-zinc-800 shadow-lg backdrop-blur-sm timeline range/0%,200px no-animations:translate-y-0 dark:border-b-slate-600/50 dark:bg-slate-800/60 dark:text-zinc-300">
