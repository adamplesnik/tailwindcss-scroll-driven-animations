...
const MultiRangeDemo = () => {
  return (
    <DemoWrapper className="flex flex-col gap-4 scope/range-demo sm:flex-row sm:gap-12">
      <div className="sticky top-0 flex flex-1 flex-col gap-2 bg-zinc-100/20 p-4 backdrop-blur sm:gap-6 sm:bg-transparent dark:bg-zinc-800/20 dark:sm:bg-transparent">
        <DemoAnimationExampleRow animations="range-on-entry" timeline="timeline/range-demo" />
        <DemoAnimationExampleRow animations="range" timeline="timeline/range-demo" />
        <DemoAnimationExampleRow animations="range-contain" timeline="timeline/range-demo" />
        <DemoAnimationExampleRow animations="range-on-exit" timeline="timeline/range-demo" />
      </div>
      <div className="w-full flex-[2] px-4 sm:pl-0">
        ...
        <DemoTriggerLine />
        <div className="px-2 py-4 view-timeline/range-demo sm:px-4">
