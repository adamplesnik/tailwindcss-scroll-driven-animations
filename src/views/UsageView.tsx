...
const UsageView = () => {
  return (
    <Page>
      ...
      <Usage />
      <div className="mb-4 mt-8 flex items-center gap-2 rounded-lg border border-sky-300 bg-sky-100 p-2 text-sm  dark:border-sky-600 dark:bg-sky-700/30">
        <Info className="size-5 shrink-0 text-sky-500 dark:text-sky-600" strokeWidth="1.5" />
